...
def get_electricity_price(dt: datetime) -> float:
    ...
    if (
        ...
        return 0
    if dt >= datetime(2026, 5, 1, tzinfo=LONDON):
        return 0.08625 if cheap_rate else 0.3179
    if dt >= datetime(2026, 4, 1, tzinfo=LONDON):
        return 0.065 if cheap_rate else 0.28604
